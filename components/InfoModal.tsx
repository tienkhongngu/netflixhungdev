...
const InfoModal: React.FC<InfoModalProps> = ({visible, onClose}) => {
    const [inVisible, setIsVisible] = useState(!!visible);
    ...
    return (
        <div className='
            ...
            flex justify-center overflow-x-hidden overflow-y-auto
            fixed inset-0   '>
            <div className='relative w-auto m-auto max-w-3xl rounded-md overflow-hidden'>
                <div className={
